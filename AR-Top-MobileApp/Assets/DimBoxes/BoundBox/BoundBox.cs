...
namespace DimBoxes
{
    ...
    public class BoundBox : MonoBehaviour
    {
        ...
        void setPoints()
        {
            ...
            bound.size = new Vector3(bound.size.x * transform.lossyScale.x / startingScale.x, bound.size.y * transform.lossyScale.y / startingScale.y, bound.size.z * transform.lossyScale.z / startingScale.z);
            boundOffset = new Vector3(boundOffset.x * transform.lossyScale.x / startingScale.x, boundOffset.y * transform.lossyScale.y / startingScale.y, boundOffset.z * transform.lossyScale.z / startingScale.z);
