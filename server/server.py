try:
	...
	print("You're missing some core modules, or you may not be using your virtualenv.")
	print(e)
	exit()
...
try:
	...
	print("You're missing some imports.")
	print(e)
	exit()
...
def register():
	...
	try:
		...
		return jsonify(error="Malformed request; expecting email and password, got " + str(request.form))
	...
	if not str.isalnum(password):
		return jsonify(error="Only allow alphanumeric characters are allowed in a password.")
	...
	# TODO: error handle this. Can't tell the user you registered successfully in the next line if the email fails.
...
if __name__ == '__main__':
	...
	parser.add_argument("-e", "--email", nargs='+', type=str, help="Sends an email if you use commandline friendly text")
